            ...
            <td style="padding: 40px;">
              ...
              <div style="padding: 20px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid #60a5fa; border-radius: 8px; margin: 0 0 30px;">
                ...
                <ol style="margin: 0; padding-left: 20px; color: #C8B896; font-size: 14px; line-height: 1.8;">
                  ...
                  <li>Выполните <strong style="color: #FFB347;">оплату</strong> по указанным реквизитам</li>
                  <li>Отправьте <strong style="color: #FFB347;">чек об оплате</strong> организаторам</li>
                </ol>
              </div>
...
3. Выполните оплату по указанным реквизитам
4. Отправьте чек об оплате организаторам
