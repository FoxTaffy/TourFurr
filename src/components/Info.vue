<template>
  ...
  const includedItems = [
    ...
    { id: 2, text: 'Питание (завтраки, обеды и ужины включены в стоимость)' },
    { id: 3, text: 'Доступ ко всем зонам и активностям' },
    { id: 4, text: 'Участие в ролевых играх и мероприятиях' },
    { id: 5, text: 'Костровые посиделки и вечерние программы' },
    { id: 6, text: 'Печатная карта территории' }
  ]
  </script>
